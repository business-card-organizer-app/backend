...
route.post('/api/user/:id/collection', auth.authToken, auth.authUser, userMidle.validateId, collectionMidle.validateCollection, collectionCtr.addCardCollection);
